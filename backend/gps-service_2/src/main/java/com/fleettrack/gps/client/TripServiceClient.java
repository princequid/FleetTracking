...
// Used to verify a DRIVER caller actually owns the trip they're pinging/reading —
// the injected RestTemplate already stamps X-Internal-Service-Key via its interceptor
// (see RestTemplateConfig), so no manual header handling is needed here.
@Component
